...
class LinkedList {
  ...
  insertBefore(item, newItem) {
    ...
    if(currNode.value === item){
      let newNode = new _Node(newItem, currNode, previousNode);
...
class SinglyLinkedList {
    ...
    insertFirst(item) {
      // create a new node then...
      //assign the head to the address of the new node
      this.head = new single_Node(item, this.head);
    }
    ...
    insertLast(item) {
      ...
      // new node.
        ...
        tempNode.next = new single_Node(item, null);
      }
    ...
    insertBefore(item, newItem) {
      ...
      //if we have found the item we are lookign for, create new node at current node position
      if(currNode.value === item){
        let newNode = new single_Node(newItem, currNode);
    ...
    insertAt(position, item) {
      ...
      if (index === position) {
        let newNode = new single_Node(item, currNode);
        previousNode.next = newNode;
      }
  ...
  module.exports = {SinglyLinkedList, LinkedList};